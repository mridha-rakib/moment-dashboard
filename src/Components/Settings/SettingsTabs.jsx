    ...
    { id: 'General', icon: <User size={18} />, label: 'General' },
    {
      id: 'Mooment Credit', icon: (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M15.7712 8.20494C15.555 7.29281 14.4546 6.46974 13.1337 7.08549C11.8128 7.70124 11.603 9.68239 13.601 9.89285C14.5041 9.98798 15.0928 9.78247 15.6319 10.3638C16.1709 10.9451 16.2711 12.5617 14.8931 12.9974C13.5151 13.4331 12.1506 12.7523 12.002 11.7857M13.9862 6.00391V6.87295M13.9862 13.1315V14.0039" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      ), label: 'Mooment Credit'
    },
    {
      id: 'Pricing', icon: (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
